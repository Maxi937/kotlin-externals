 ...
 */
external interface CustomEditorProvider<T : CustomDocument /* default is CustomDocument */> :
   ...
   */
  val onDidChangeCustomDocument: Union<Event<CustomDocumentEditEvent<T>>, Event<CustomDocumentContentChangeEvent<T>>> // Event<CustomDocumentEditEvent<T>> | Event<CustomDocumentContentChangeEvent<T>>
